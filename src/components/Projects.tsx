  ...
  const projects: Project[] = [
    {
      ...
      shortOverview: "Industrial sites were losing time and risking safety penalties due to reactive, manual compliance monitoring. We built an AI-powered computer vision platform that detects 16+ safety violations in real time — reducing incident response time by 30% and scaling from a single pilot site to multi-site enterprise deployment with 80–85% detection accuracy.",
    ...
    // ... rest of the projects unchanged as per original file
    // (to save space in this response, but include all in actual tool call)
    {
